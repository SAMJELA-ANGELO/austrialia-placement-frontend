<template>
  <section class="relative">
    ...
    <div class="pt-12 w-full">
      <div class="grid gap-8 pb-24 shape row-gap-10 mb-8 md:grid-cols-6">
        ...
        >
          <div v-for="items in [1, 2, 3, 4]" v-bind:key="items">
            <p class="font-medium tracking-wide text-gray-700">Category</p>
            <ul class="mt-2 space-y-2">
              <li v-for="links in [1, 2, 3, 4]" v-bind:key="links">
                <a
                  href="/"
                  class="transition-colors duration-300 font-light text-gray-400 hover:text-gray-600"
                  >News</a
                >
              </li>
            </ul>
      ...
      <div
        class="flex shape bottom flex-col justify-between py-5 border-t sm:flex-row"
      >
...
<script>
import SubscribeReusable from "./SubscribeReusable";
export default {
  name: "FooterReusable",
  components: { SubscribeReusable },
};
</script>
